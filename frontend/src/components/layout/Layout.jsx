...
const Layout = () => {
  ...
  const isActive = (path) => {
    // Exact match for root paths like /hod, /student, etc.
    if (path === location.pathname) {
      return true;
    }
    // Path match for nested routes (e.g., /hod/faculty when on /hod/faculty)
    ...
    switch (user.role) {
      case 'student':
        return [
          ...
          { name: 'Submit Proposal', path: '/student/proposal', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
          ...
          { name: 'Evaluation', path: '/student/evaluation', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
      ...
      case 'hod':
        return [
          ...
          { name: 'Assigned Guides', path: '/hod/guides', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
